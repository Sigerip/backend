...
CORS(app, resources={
    r"/*": {
        "origins": ["http://localhost:3000", "http://localhost:5173", "http://localhost:8080", "http://127.0.0.1:8001", "https://oiatuarial.vercel.app", "https://frontend-git-develop-oiatuarials-projects.vercel.app"],
